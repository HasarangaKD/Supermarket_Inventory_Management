...
router.post('/', (req, res, next) => {
    let inventory = new Inventory({StockID: req.body.StockID,ItemName: req.body.ItemName,ItemType: req.body.ItemType, quantity: req.body.quantity,UnitPrice: req.body.UnitPrice})
    inventory.save()
    .then(inventory => {
